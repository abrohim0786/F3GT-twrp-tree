...
# F2FS and crypto tools
TW_INCLUDE_F2FS_TOOLS := true
TW_INCLUDE_FSCK_F2FS := true
TW_INCLUDE_F2FS_FMT := true
TW_INCLUDE_F2FS_REPAIR := true

# fstab
TARGET_RECOVERY_FSTAB := $(DEVICE_PATH)/recovery.fstab
TARGET_RECOVERY_WIPE := $(DEVICE_PATH)/recovery.wipe

# Additional fstab for dynamic partitions
TARGET_RECOVERY_ADDITIONAL_FSTAB := $(DEVICE_PATH)/recovery/root/etc/additional.fstab
